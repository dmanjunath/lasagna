...
export default function PortfolioComposition() {
  ...
  if (loading) {
    return (
      <div className="mx-auto max-w-[1180px] px-3 sm:px-12 pt-3 sm:pt-10 pb-6 sm:pb-28 text-content">
  ...
  return (
    <div
      className="mx-auto max-w-[1180px] px-3 sm:px-12 pt-3 sm:pt-10 pb-6 sm:pb-28 text-content"
