...
//   - fiReached:    Layer 11 complete, will and trust outstanding
//
...
export const DEEP_DEBT_PERSONA: MockPersona = {
  ...
  steps: [
    ...
    },
    {
      ...
      subtitle: '3 to 6 months essential expenses liquid',
      description:
    ...
    },
    {
      ...
      subtitle: 'Enough to replace your income for the people who rely on it',
      description: 'Term life replaces your income for the people who depend on it.',
      icon: 'shield',
      status: 'not_started',
      skipped: false,
      current: null,
    ...
    },
    {
      ...
      subtitle: 'Address all debt 8 to 15% APR',
      description: 'Debt in the 8 to 15% range is roughly break-even with expected market returns.',
      icon: 'credit-card',
      status: 'not_started',
      skipped: false,
      current: null,
    ...
    },
    {
      ...
      description: 'A will directs what you own to the people you choose, and without one the state decides instead.',
      icon: 'scroll-text',
      status: 'not_started',
      skipped: false,
      current: null,
  ...
  insights: [
    ...
    },
    {
      ...
      description: 'Contributing 6% to get the 3% full match. That is a 100% instant return. Keep it up while attacking high-rate debt.',
...
export const MIXED_PERSONA: MockPersona = {
  ...
  insights: [
    ...
    },
    {
      ...
      description: 'You have contributed $2,500 of the $7,000 Roth IRA limit. You have 4 months to max it at $625/mo.',
