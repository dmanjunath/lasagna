  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        >
          <div className="font-mono text-[11px] uppercase tracking-[0.14em] text-text-secondary font-semibold">
            Succeeded
          </div>
            ...
            <tr>
              {(
                ...
                <th
                  ...
                  className="font-mono text-[11px] uppercase tracking-[0.14em] text-text-secondary font-semibold px-3 py-2 text-left cursor-pointer select-none hover:text-text-primary"
                >
                  {label}
                  <SortIcon column={key} />
                </th>
