...
export function inviteText(inviter: string, acceptUrl: string, recipient: string): string {
  return [
    `${inviter} invited you to their household on Lasagna.`,
    ``,
    `Lasagna is a calmer way to see your money — accounts, balances, and plans in one place. ${inviter} wants to share theirs with you, so you both see the same picture while keeping your own private login and chat.`,
    ``,
    `Join here:`,
    acceptUrl,
    ``,
    ...
    ``,
    `Lasagna, by SuperCoolLabs LLC. We are not a financial advisor and this is not financial advice.`,
  ].join("\n");
}
...
<html lang="en">
  <head>
    ...
    <title>You're invited to Lasagna</title>
  </head>
          ...
          <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="width:480px;max-width:100%;background:#ffffff;border-radius:18px;border:1px solid #e6e9ef;overflow:hidden;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
            ...
            <tr>
              <td style="padding:26px 34px 0;">
                <span style="font-size:17px;font-weight:800;letter-spacing:-0.02em;color:#05b279;">Lasagna</span>
              </td>
            </tr>
            <tr>
              <td style="padding:18px 34px 0;">
                ...
                <div style="font-size:15px;line-height:1.6;color:#475467;margin:0 0 24px;">Lasagna is a calmer way to see your money, all in one place. <strong style="color:#1d2939;font-weight:600;">${escHtml(inviter)}</strong> wants to share theirs with you, so you both see the same accounts, balances, and plans, while each keeping your own private login and chat.</div>
            ...
            <tr>
              <td style="padding:16px 34px 28px;">
                <div style="font-size:12px;line-height:1.6;color:#98a2b3;">This invite was sent to ${escHtml(recipient)}. No account is created until you accept, and nothing changes on your side if you ignore it.<br /><br />Lasagna, by SuperCoolLabs&nbsp;LLC. Not a financial advisor.</div>
              </td>
            </tr>
          </table>
        </td>
