...
describe("buildPeriods (month)", () => {
  it("zero-fills the last N months and aggregates income/expenses/net", () => {
    const rows = [
      { period: "2026-06", amount: "100.00", category: "groceries" },
      { period: "2026-06", amount: "-3000.00", category: "income" },
      { period: "2026-05", amount: "50.00", category: "shopping" },
    ];
  ...
  it("excludes transfers", () => {
    const rows = [
      { period: "2026-07", amount: "500.00", category: "transfer" },
      { period: "2026-07", amount: "-500.00", category: "transfer" },
    ];
...
describe("buildPeriods (year)", () => {
  it("spans earliest data year through the current year when limit is null", () => {
    const rows = [
      { period: "2024", amount: "10.00", category: "other" },
      { period: "2026", amount: "20.00", category: "other" },
    ];
  ...
  it("respects an explicit year limit", () => {
    const rows = [{ period: "2020", amount: "10.00", category: "other" }];
