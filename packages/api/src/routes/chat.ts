...
chatRouter.post("/", async (c) => {
  ...
  // finalText is already descrubbed — llmGenerateText restores real names on
  // the way back. Descrubbing again would corrupt names whose real form
  // contains a bare debt alias ("auto", "mortgage") that re-expands.
